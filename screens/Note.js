...
import { collection, getDoc, doc, getDocFromCache, updateDoc } from "firebase/firestore";
  ...
  submit = async () => {
      if(this.state.title === '') {
        ...
        try{
            ...
            const update = await updateDoc(docRef, this.state.data)
            this.setState({
                isLoading: false,
                data:{}
            })
